...
import requests 
url='https://raw.githubusercontent.com/imShashanKashyap/Diabetes_Model/main/diabetes_model_.pkl'

# url='https://github.com/imShashanKashyap/Diabetes_Model/blob/main/diabetes_model_.pkl'
